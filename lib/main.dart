...
void main() {
  runApp(const CoreGen());
}

class CoreGen extends StatelessWidget {
  const CoreGen({super.key});
...
class _GetPinGenPage extends State<PinGenPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Helper.getMainColor(false),
      appBar: AppBar(
        title:  Text(
          "PinG",
          style: TextStyle(
                ...
                children: <Widget>[
                  Padding(
                      ...
                      child: Container(
                        ...
                        width: 330,
                        decoration: BoxDecoration(
                            color: Helper.getMainColor(false),
                  ...
                  Padding(
                      ...
                      child: SwitchListTile(
                        ...
                        selectedTileColor: Helper.getMainColor(false),
                        tileColor: Helper.getMainColor(false),
                        secondary: Icon(
                          Icons.gpp_good,
                          color: Helper.getMainColor(false),
                        ),
                ...
                children: <Widget>[
                  LayoutBuilder(builder: (context, constrains) {
                    return Container(
                      ...
                      width: 50,
                      decoration: BoxDecoration (
                          color: Helper.getMainColor(true),
...
class _GetPasswordGenPage extends State<PasswordGenPage> {
  ...
  String _nowPassword = "Pass Generator";
